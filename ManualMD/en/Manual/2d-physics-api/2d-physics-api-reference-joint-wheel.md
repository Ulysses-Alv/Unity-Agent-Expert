...
Explore the properties you can use to configure a `LowLevelPhysics2D` API wheel **joint** in the Unity Editor.
...
* [`PhysicsWheelJointDefinition`](../../ScriptReference/LowLevelPhysics2D.PhysicsWheelJointDefinition.md)
