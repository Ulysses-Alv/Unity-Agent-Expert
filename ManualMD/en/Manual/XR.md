...
![Sample XR scene view](../uploads/Main/xr-hero-img.png)
...
| Topic | Description |
| --- | --- |
| [Overview](xr-support-landing.md) | An overview of how Unity supports XR development. |
| [Set up an XR Project](configuring-project-for-xr.md) | How to set up a project for an XR game or application. |
| [Set up an XR scene](xr-scene-setup.md) | How to add the **GameObjects** and components needed by an XR **scene**. |
| [Run an XR application](xr-run.md) | How to build and run Unity XR projects during development. |
| [XR graphics](xr-graphics.md) | XR-specific graphics topics. |
| [XR audio](xr-audio.md) | Understand audio for XR projects. |
