...
1. Create a URP **shader** that samples a texture called `_BaseMap`. For an example, refer to [Drawing a texture](writing-shaders-urp-unlit-texture.md).
...
4. In the active URP renderer, [add the Scriptable Renderer Feature](urp-renderer-feature.md).
