...
You can use the [Rendering Debugger](features/rendering-debugger-reference.md#probe-volume-panel) to preview transitions between Lighting Scenarios. Follow these steps:
