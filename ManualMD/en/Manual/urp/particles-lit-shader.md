...
Explore the properties and settings you can use to customize the default **Particles** Lit **shader** in the Universal **Render Pipeline** (URP).

URP uses the Particles Lit shader for the built-in **particle system**. For more information, refer to [Choosing your particle system solution](../ChoosingYourParticleSystem.md).
