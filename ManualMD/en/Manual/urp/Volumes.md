...
The Universal **Render Pipeline** (URP) uses volumes for [post-processing](add-post-processing.md) effects. Volumes can override or extend **scene** properties depending on the **camera** position relative to each volume.
...
![Vignette post-processing effect in the URP Template SampleScene](../../uploads/urp/post-proc/post-proc-as-volume-override.png)
