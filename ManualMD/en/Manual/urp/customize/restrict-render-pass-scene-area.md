...
To restrict a render pass to a specific area of a **scene**, add a [volume](../volumes-landing-page.md) to the scene, then add code to your render pass and your **shader** to check if the **camera** is inside the volume.
...
* [Volumes in URP](../volumes-landing-page.md)
