...
**Note:** For URP 17.2 (Unity 6.2) and later, refer to the main [What’s new in Unity](../../WhatsNew.md) section.
...
For example, you can [change the maximum number of visible lights](../rendering/forward-plus-rendering-path-limitations.md).
