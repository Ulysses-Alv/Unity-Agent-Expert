...
A video clip asset is an imported video file, which you can reference in the [Video Player component](class-VideoPlayer.md) to play video content in your application.

This information covers using video clip assets only. To use the Video Clip Importer, refer to [Video Clip](class-VideoClip.md). To transcode video clips, refer to [Video transparency support](VideoTransparency.md).
...
Next, configure your [Video Clip Importer](class-VideoClip.md) properties or [reference the video clip](video-sources-reference.md#videoclip) in the Video Player.
...
After you select **Source Info**, you can view information about your video clip, such as its size, duration, frames, and **pixels**.

## Additional resources

* [Reference video sources](video-sources-reference.md)
