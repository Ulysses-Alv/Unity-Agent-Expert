...
A ToolbarSearchField is an [Editor-only](UIB-interface-overview.md#enable-editor-extension-authoring-for-ui-documents-uxml) control that serves as a search field. It’s a [TextField](UIE-uxml-element-TextField.md) with predefined styles that matches the [Toolbar](UIE-uxml-element-Toolbar.md) style.

![An example ToolbarSearchField](../uploads/Main/uxml/toolbar-search-field.png)

An example ToolbarSearchField
...
**C# class**: [`ToolbarSearchField`](../ScriptReference/UIElements.ToolbarSearchField.md)  
**Namespace**: `UnityEditor.UIElements`  
**Base class**: [`SearchFieldBase_2`](../ScriptReference/UIElements.SearchFieldBase_2.md)
