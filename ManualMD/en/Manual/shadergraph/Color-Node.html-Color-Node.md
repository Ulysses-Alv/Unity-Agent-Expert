# Color Node | Shader Graph | 17.6.0

Source: [Original](https://docs.unity3d.com/Packages/com.unity.shadergraph@17.6/manual/Color-Node.html)

# Color Node

## Description

Defines a constant **Vector 4** value in the shader using a **Color** field. Can be converted to a **Color** [Property Type](Property-Types.html) via the [Node's](Node.html) context menu. The value of the **Mode** parameter will also respected when generating the [Property](Property-Types.html).
...
| **Mode** | Sets properties of the Color field. The options are:  * **Default** * **HDR** |
