# Shader Graph keyboard shortcuts reference | Shader Graph | 17.6.0

Source: [Original](https://docs.unity3d.com/Packages/com.unity.shadergraph@17.6/manual/Keyboard-shortcuts.html)
...
| --- | --- | --- | --- |
| Frame All | A | A | Display the entire graph in the [Shader Graph window](Shader-Graph-Window.html). |
| Frame Selection | F | F | Display the selected nodes of the graph in the [Shader Graph window](Shader-Graph-Window.html). |
...
| Toggle Blackboard | Shift + 1 | Shift + 1 | Toggle the [Blackboard](Blackboard.html) on and off. |
| Toggle Inspector | Shift + 2 | Shift + 2 | Toggle the [Graph Inspector](Internal-Inspector.html) on and off. |
| Toggle Main Preview | Shift + 3 | Shift + 3 | Toggle the [Main Preview](Main-Preview.html) on and off. |
...
* [Graph Inspector](Internal-Inspector.html)
* [Main Preview](Main-Preview.html)
