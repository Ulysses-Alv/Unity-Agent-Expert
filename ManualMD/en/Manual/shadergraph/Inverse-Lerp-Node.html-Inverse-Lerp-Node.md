# Inverse Lerp Node | Shader Graph | 17.6.0

Source: [Original](https://docs.unity3d.com/Packages/com.unity.shadergraph@17.6/manual/Inverse-Lerp-Node.html)
...
**Inverse Lerp** is the inverse operation of the [Lerp Node](Lerp-Node.html). It can be used to determine what the input to a [Lerp](Lerp-Node.html) was based on its output.
