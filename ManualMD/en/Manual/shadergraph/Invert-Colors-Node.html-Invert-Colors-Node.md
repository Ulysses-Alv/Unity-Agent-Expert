# Invert Colors Node | Shader Graph | 17.6.0

Source: [Original](https://docs.unity3d.com/Packages/com.unity.shadergraph@17.6/manual/Invert-Colors-Node.html)

# Invert Colors Node

## Description

Inverts the colors of input **In** on a per channel basis. This [Node](Node.html) assumes all input values are in the range 0 - 1.
