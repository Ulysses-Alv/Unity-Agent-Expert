# Scene Depth node | Shader Graph | 17.6.0

Source: [Original](https://docs.unity3d.com/Packages/com.unity.shadergraph@17.6/manual/Scene-Depth-Node.html)
...
The Scene Depth node works only in the fragment [shader stage](Shader-Stage.html), and might not work if you set **Surface Type** to **Opaque** in the **Graph Inspector** window.
