# Dielectric Specular Node | Shader Graph | 17.6.0

Source: [Original](https://docs.unity3d.com/Packages/com.unity.shadergraph@17.6/manual/Dielectric-Specular-Node.html)

# Dielectric Specular Node

## Description

Returns a **Dielectric Specular** F0 value for a physically based material. The material to use can be selected with the **Material** dropdown parameter on the [Node](Node.html).
...
| Control | Description |
| --- | --- |
| **Material** | Selects the material value to output. The options are:  * **Common** * **RustedMetal** * **Water** * **Ice** * **Glass** * **Custom** |
