# Preview mode control | Shader Graph | 17.6.0

Source: [Original](https://docs.unity3d.com/Packages/com.unity.shadergraph@17.6/manual/Preview-Mode-Control.html)
...
This mode control functionality also applies to Sub Graph previews. See [Graph Settings menu](Graph-Settings-Tab.html).
...
* Select a mode in the [Sub Graph](Sub-graph.html) [Graph Settings](Graph-Settings-Tab.html) menu.

## Additional resources

* [Preview node](Preview-Node.html)