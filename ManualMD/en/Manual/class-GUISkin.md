...
[Switch to Scripting](../ScriptReference/GUISkin.md "Go to GUISkin page in the Scripting Reference")
...
**Please Note**: This page refers to part of the [IMGUI](GUIScriptingGuide.md) system, which is a *scripting-only* UI system. Unity has a full GameObject-based UI system which you may prefer to use. It allows you to design and edit user interface elements as visible objects in the **scene** view. See the [UI System Manual](com.unity.ugui.md) for more information.
...
| **Box** | The [Style](class-GUIStyle.md) to use for all Boxes |
| **Button** | The [Style](class-GUIStyle.md) to use for all Buttons |
| **Toggle** | The [Style](class-GUIStyle.md) to use for all Toggles |
| **Label** | The [Style](class-GUIStyle.md) to use for all Labels |
| **Text Field** | The [Style](class-GUIStyle.md) to use for all Text Fields |
| **Text Area** | The [Style](class-GUIStyle.md) to use for all Text Areas |
| **Window** | The [Style](class-GUIStyle.md) to use for all Windows |
| **Horizontal Slider** | The [Style](class-GUIStyle.md) to use for all Horizontal Slider bars |
| **Horizontal Slider Thumb** | The [Style](class-GUIStyle.md) to use for all Horizontal Slider Thumb Buttons |
| **Vertical Slider** | The [Style](class-GUIStyle.md) to use for all Vertical Slider bars |
| **Vertical Slider Thumb** | The [Style](class-GUIStyle.md) to use for all Vertical Slider Thumb Buttons |
| **Horizontal Scrollbar** | The [Style](class-GUIStyle.md) to use for all Horizontal Scrollbars |
| **Horizontal Scrollbar Thumb** | The [Style](class-GUIStyle.md) to use for all Horizontal Scrollbar Thumb Buttons |
| **Horizontal Scrollbar Left Button** | The [Style](class-GUIStyle.md) to use for all Horizontal Scrollbar scroll Left Buttons |
| **Horizontal Scrollbar Right Button** | The [Style](class-GUIStyle.md) to use for all Horizontal Scrollbar scroll Right Buttons |
| **Vertical Scrollbar** | The [Style](class-GUIStyle.md) to use for all Vertical Scrollbars |
| **Vertical Scrollbar Thumb** | The [Style](class-GUIStyle.md) to use for all Vertical Scrollbar Thumb Buttons |
| **Vertical Scrollbar Up Button** | The [Style](class-GUIStyle.md) to use for all Vertical Scrollbar scroll Up Buttons |
| **Vertical Scrollbar Down Button** | The [Style](class-GUIStyle.md) to use for all Vertical Scrollbar scroll Down Buttons |
...
After you have created a GUISkin, you can edit all of the [Styles](class-GUIStyle.md) it contains in the **Inspector**. For example, the **Text Field** [Style](class-GUIStyle.md) will be applied to all Text Field Controls.
