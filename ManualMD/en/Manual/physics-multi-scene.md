...
![Example: trajectory prediction](../uploads/Main/physics-multi-scene-pool.png)
...
You can use [Multi-Scene editing](MultiSceneEditing.md) to create multiple Scenes in general (although you can also instantiate them by script). However, you have to use the Unity scripting API to use independent physics Scenes in runtime.
