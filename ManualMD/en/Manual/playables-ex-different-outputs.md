...
4. If you have installed the [PlayableGraph Visualizer package](playables-visualizer.md), select `MultiOutputSample` to display the PlayableGraph.

![The PlayableGraph generated by the DifferentOutputs script.](../uploads/Main/playables-vis-different-outputs.png)
