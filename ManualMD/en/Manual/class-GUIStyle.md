...
[Switch to Scripting](../ScriptReference/GUIStyle.md "Go to GUIStyle page in the Scripting Reference")
...
If you want to add style to more than one control, use a [GUI Skin](class-GUISkin.md) instead of a GUI Style. For more information about IMGUI, please read the [GUI Scripting Guide](GUIScriptingGuide.md).
...
For more information about using IMGUI, please read the [GUI Scripting Guide](GUIScriptingGuide.md).
