...
Customize the Standard **shader** for different use cases by downloading the shader source code, and then editing it to fit your project needs.
...
* [Writing custom shaders](writing-custom-shaders.md)
