...
[Switch to Scripting](../ScriptReference/OcclusionPortal.md "Go to OcclusionPortal page in the Scripting Reference")
...
4. Bake the occlusion data for your Scene. See [Getting started with occlusion culling](occlusion-culling-getting-started.md) for instructions.
...
Use a script to set the Occlusion Portal’s [open](../ScriptReference/OcclusionPortal-open.md) property to the desired state.
