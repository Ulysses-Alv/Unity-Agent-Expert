...
| **Topic** | **Description** |
| --- | --- |
| [API compatibility levels for .NET](dotnet-profile-support.md) | Choose between the different .NET API compatibility levels that Unity can compile your project code against. |
| [Add class library references to .NET Framework](dotnet-profile-assemblies.md) | Reference parts of the .NET class library API that Unity doesn’t compile by default. |
| [C# compiler and language version reference](csharp-compiler.md) | Details and limitations of the C# compiler and C# language version Unity uses. |
