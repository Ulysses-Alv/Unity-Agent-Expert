...
The BoundsIntField lets users enter a [BoundsInt](../ScriptReference/BoundsInt.md) value in a UI.
...
**C# class**: [`BoundsIntField`](../ScriptReference/UIElements.BoundsIntField.md)  
...
* [BoundsField](UIE-uxml-element-BoundsField.md)