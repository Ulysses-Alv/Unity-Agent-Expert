...
BatchRendererGroup (BRG) is an API for high-performance custom rendering in projects that use a [Scriptable Render Pipeline](scriptable-render-pipeline-introduction.md) (SRP) and the [SRP Batcher](SRPBatcher.md).
