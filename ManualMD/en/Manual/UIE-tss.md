...
Theme Style Sheet (TSS) files are regular [USS](UIE-USS.md) files. UI Toolkit treats TSS as a distinct asset type and uses it for management purposes.
...
2. Do one of the following:
   ...
   * Select **Assets** > **Create** > **UI Toolkit** > **TSS Theme File** to create an empty theme file and [import the default theme](#inherit-a-theme).
...
You can [reference a TSS in UXML](UIE-add-style-to-uxml.md) or [C#](UIE-apply-styles-with-csharp.md) the same way as you do with USS.

You can also set a TSS as the default theme for a [Panel Setting](UIE-Runtime-Panel-Settings.md) asset. If you have more than one Panel Setting, each one can use a different TSS file.
