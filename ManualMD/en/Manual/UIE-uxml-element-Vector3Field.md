...
A Vector3Field lets users enter a [Vector3](../ScriptReference/Vector3.md) value.

**Note**: To align a Vector3Field with other fields in an **Inspector** window, simply apply the `.unity-base-field__aligned` USS class to it. For more information, refer to [`BaseField`](../ScriptReference/UIElements.BaseField_1.md).
...
**C# class**: [`Vector3Field`](../ScriptReference/UIElements.Vector3Field.md)  
