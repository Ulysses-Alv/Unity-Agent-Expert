...
In any given **scene**, some **GameObjects** are compatible with the SRP Batcher, and some aren’t. Compatible GameObjects use the SRP Batcher code path, and non-compatible GameObjects use the standard SRP code path. For more information, see [How the SRP Batcher works](SRPBatcher.md#how-the-srp-batcher-works).
...
* The GameObject mustn’t use [MaterialPropertyBlocks](../ScriptReference/MaterialPropertyBlock.md).
...
![You can check the compatibility of your shaders in the Inspector panel for the specific shader.](../uploads/Main/SRP_batcher_shader_compatibility.png)
