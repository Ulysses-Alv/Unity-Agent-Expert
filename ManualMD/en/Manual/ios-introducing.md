...
| **Topic** | **Description** |
| --- | --- |
| [iOS requirements and compatibility](ios-requirements-and-compatibility.md) | Understand the requirements for iOS development in Unity and Unity feature compatibility on iOS devices. |
| [How Unity builds iOS applications](how-unity-builds-ios-applications.md) | Understand the iOS application build process. |
| [iOS XCode Project Structure](StructureOfXcodeProject.md) | Understand the structure of a Unity Xcode project. |