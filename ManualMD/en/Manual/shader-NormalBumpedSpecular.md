...
**Note.** Unity 5 introduced the [Standard Shader](shader-StandardShader.md) which replaces this`

![Normal Bumped Specular shader](../uploads/Shaders/Shader-NormalBumpSpec.jpg)

Normal Bumped Specular shader
