...
| **Property** | **Function** |
| --- | --- |
| **Remove Ringing** | When this property is enabled, Unity automatically removes **Light Probe** ringing from the **Scene**. For more information, refer to [Ringing](light-probes-troubleshooting.md#Ringing). |
