...
The [Import Activity window](ImportActivityWindow.md) displays information about how Unity imported assets into your project. To open the window, go to **Window** > **Analysis** > **Import Activity**. The window contains the following information:
...
| **GUID** | [The unique GUID assigned to the asset](AssetMetadata.md#asset-ids). You can use this to track its references across your project. |
...
For more information, refer to [Overview of import data](ImportActivityWindow.md#overview-of-import-data).
