...
4. If you have installed the [PlayableGraph Visualizer package](playables-visualizer.md), select `PlayAnimationClip` to display the PlayableGraph:

![The PlayableGraph generated by the PlayAnimationClip script](../uploads/Main/playables-vis-play-clip.png)
