...
A ToolbarMenu is an [Editor-only](UIB-interface-overview.md#enable-editor-extension-authoring-for-ui-documents-uxml) control that serves as a menu. It has a predefined style that matches the [Toolbar](UIE-uxml-element-Toolbar.md) style.
...
**C# class**: [`ToolbarMenu`](../ScriptReference/UIElements.ToolbarMenu.md)  
