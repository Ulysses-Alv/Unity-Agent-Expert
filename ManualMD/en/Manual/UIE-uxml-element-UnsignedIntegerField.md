...
**Note**: To align an UnsignedIntegerField with other fields in an **Inspector** window, apply the `.unity-base-field__aligned` USS class to it. For more information, refer to [`BaseField`](../ScriptReference/UIElements.BaseField_1.md).
...
**C# class**: [`UnsignedIntegerField`](../ScriptReference/UIElements.UnsignedIntegerField.md)  
