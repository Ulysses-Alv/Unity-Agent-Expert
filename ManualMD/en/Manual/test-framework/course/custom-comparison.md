...
Similar to the project for exercise 3, the [sample](test-framework-general-introduction.md#import-samples) `4_CustomComparison` contains a `ValueOutputter` class.
