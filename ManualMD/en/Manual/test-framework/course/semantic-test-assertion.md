...
In the `3_SemanticTestAssertion` [sample](test-framework-general-introduction.md#import-samples), there is a class called `ValueOutputter`, which returns values of different types.
...
* [Constraint-Based Assert Model](https://nunit.org/docs/2.4/constraintModel.html)