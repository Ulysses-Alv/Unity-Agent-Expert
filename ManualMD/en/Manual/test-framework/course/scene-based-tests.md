...
The [EditorSceneManager](../../../ScriptReference/SceneManagement.EditorSceneManager.md) allows for loading and saving scenes. In combination with the test framework, this allows for the implementation of tests that verify a scene.
...
Import the [sample](test-framework-general-introduction.md#import-samples) `11_SceneBasedTests`, which contains a scene named `MyGameScene` and an assembly for Edit Mode tests.
...
[API reference for `EditorSceneManager`](../../../ScriptReference/SceneManagement.EditorSceneManager.md)