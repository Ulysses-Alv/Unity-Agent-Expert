...
The [sample](test-framework-general-introduction.md#import-samples) `7_PlayModeTests` contains an empty project. Import this sample and add a new assembly for Play Mode tests.
