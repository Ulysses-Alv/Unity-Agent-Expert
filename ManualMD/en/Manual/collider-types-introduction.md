...
For details on how the different collider types interact, refer to [Interaction between collider types](collider-types-interaction.md).
...
* Act as a [trigger collider](collider-interactions.md), and receive trigger events from other colliders
* Apply [friction](collider-surface-friction.md) to other colliders
