...
1. Download the installer files for Unity and other components to a folder on your computer. You can use individual [installer files](install-unity-with-installers.md), or installer files and the script generated by [Unity Download Assistant](install-unity-with-download-assistant.md).
...
The following procedures use the individual installer files option for installing Unity on Windows and macOS. For information about using the Download Assistant option, refer to [Install Unity on offline computers](DeployingUnityOffline.md).
...
* [Install Unity using installer files](install-unity-with-installers.md)
