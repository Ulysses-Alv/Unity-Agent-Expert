...
**Type** is the **Control Type**, and is declared by calling a function in Unity’s [GUI class](../ScriptReference/GUI.md) or the [GUILayout class](../ScriptReference/GUILayout.md), which is discussed at length in the [Layout Modes](gui-Layout.md) section of the Guide. For example, **GUI.Label()** will create a non-interactive label. All the different control types are explained later, in the [Controls](gui-Controls.md) section of the Guide.
...
The script reference page for the [GUIContent constructor](../ScriptReference/GUIContent-ctor.md) has some examples of its use.