...
Explore the properties you use to configure the shape of the **mesh** that renders a **sprite**. For more information, refer to [Crop a sprite](generate-outline.md).
...
For more information, refer to [Crop a sprite](generate-outline.md).

## Additional resources

* [Crop a sprite](generate-outline.md)
* [Custom Physics Shape tab reference for the Sprite Editor window](custom-physics-shape-editor-reference.md)