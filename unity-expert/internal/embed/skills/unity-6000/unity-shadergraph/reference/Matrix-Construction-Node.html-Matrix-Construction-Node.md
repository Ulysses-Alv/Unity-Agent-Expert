# Matrix Construction Node | Shader Graph | 17.6.0

Source: [Original](https://docs.unity3d.com/Packages/com.unity.shadergraph@17.6/manual/Matrix-Construction-Node.html)
...
| Control | Description |
| --- | --- |
| (Dropdown) | Selects how the output matrix should be filled. The options are:  * **Row**: Input vectors specify matrix rows from top to bottom. * **Column**: Input vectors specify matrix columns from left to right. |
