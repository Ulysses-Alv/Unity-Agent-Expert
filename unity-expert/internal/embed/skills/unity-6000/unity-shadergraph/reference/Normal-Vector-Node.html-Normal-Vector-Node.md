# Normal Vector node | Shader Graph | 17.6.0

Source: [Original](https://docs.unity3d.com/Packages/com.unity.shadergraph@17.6/manual/Normal-Vector-Node.html)
...
| --- | --- | --- | --- | --- |
| **Out** | Output | Vector 3 | None | The normal of the vertex or fragment of the mesh, depending on the [shader stage](Shader-Stage.html) of the graph section. |
