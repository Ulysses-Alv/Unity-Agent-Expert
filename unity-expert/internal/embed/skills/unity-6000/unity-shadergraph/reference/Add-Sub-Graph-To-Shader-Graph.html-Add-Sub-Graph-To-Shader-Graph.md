# Add a Sub Graph to a shader graph | Shader Graph | 17.6.0

Source: [Original](https://docs.unity3d.com/Packages/com.unity.shadergraph@17.6/manual/Add-Sub-Graph-To-Shader-Graph.html)

# Add a Sub Graph to a shader graph

To add a [Sub Graph](Sub-graph.html) to a shader graph, use one of the following approaches:
...
Unity adds a Sub Graph node to the shader graph. For more information, refer to [Sub Graph Node](Sub-graph-Node.html).
...
* [Sub Graph node](Sub-graph-Node.html)