...
**Note**: To align a LongField with other fields in an **Inspector** window, simply apply the `.unity-base-field__aligned` USS class to it. For more information, refer to [`BaseField`](../ScriptReference/UIElements.BaseField_1.md).

## Create a LongField

You can create a LongField with UI Builder, UXML, and C#.

To create a LongField with C#, create a new instance of a [LongField](../ScriptReference/UIElements.LongField.md) object. For example:
...
**C# class**: [`LongField`](../ScriptReference/UIElements.LongField.md)  
