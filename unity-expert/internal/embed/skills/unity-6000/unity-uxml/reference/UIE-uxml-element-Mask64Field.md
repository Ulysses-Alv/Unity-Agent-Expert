...
The Mask64Field is an [Editor-only](UIB-interface-overview.md#enable-editor-extension-authoring-for-ui-documents-uxml) control that lets users select one or more options from a list of options.

The difference between Mask64Field and [MaskField](UIE-uxml-element-MaskField.md) is that Mask64Field supports a 64-bit bitmask while MarkField supports a 32-bit bitmask.
...
The following UXML example creates a Mask64Field:

```
<UXML xmlns="UnityEngine.UIElements" xmlns:uie="UnityEditor.UIElements">
    <uie:Mask64Field label="UXML Field" name="the-uxml-field" />
</UXML>
```

The following C# example illustrates some of the customizable functionalities of the Mask64Field:
...
**C# class**: [`Mask64Field`](../ScriptReference/UIElements.Mask64Field.md)  
**Namespace**: `UnityEditor.UIElements`  
**Base class**: [`BaseMask64Field`](../ScriptReference/UIElements.BaseMask64Field.md)
...
| --- | --- | --- |
| `ussClassName` | `.unity-mask64-field` | USS class name of elements of this type. |
| `labelUssClassName` | `.unity-mask64-field__label` | USS class name of labels in elements of this type. |
| `inputUssClassName` | `.unity-mask64-field__input` | USS class name of input elements in elements of this type. |
...
* [TagField](UIE-uxml-element-TagField.md)
* [MaskField](UIE-uxml-element-MaskField.md)