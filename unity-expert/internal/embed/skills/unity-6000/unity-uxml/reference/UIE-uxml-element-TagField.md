...
The TagField is an [Editor-only](UIB-interface-overview.md#enable-editor-extension-authoring-for-ui-documents-uxml) control that lets users select a tag from a list of tags. It is commonly used in the **Inspector** window to allow users to select a tag for a **GameObject**.
...
**C# class**: [`TagField`](../ScriptReference/UIElements.TagField.md)  
