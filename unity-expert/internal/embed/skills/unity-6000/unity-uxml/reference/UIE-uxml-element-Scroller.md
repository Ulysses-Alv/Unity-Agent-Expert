...
**C# class**: [`Scroller`](../ScriptReference/UIElements.Scroller.md)  
...
| --- | --- | --- |
| `direction` | [`UIElements.SliderDirection`](../ScriptReference/UIElements.SliderDirection.md) | Direction of this scrollbar. |
