...
**C# class**: [`VisualElement`](../ScriptReference/UIElements.VisualElement.md)  
**Namespace**: `UnityEngine.UIElements`  
**Base class**: [`Focusable`](../ScriptReference/UIElements.Focusable.md)
...
* [Box](UIE-uxml-element-Box.md)
* [BindableElement](UIE-uxml-element-BindableElement.md)
* [Relative and absolute positioning](UIE-relative-absolute-positioning-example.md)