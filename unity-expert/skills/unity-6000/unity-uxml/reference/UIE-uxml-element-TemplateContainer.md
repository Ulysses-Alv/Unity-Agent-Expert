...
* When you work with [UXML templates](UIE-reuse-uxml-files.md), a TemplateContainer is generated to represent the template instance and inserted into the hierarchy of the parent UXML file.

## C# base class and namespace

**C# class**: [`TemplateContainer`](../ScriptReference/UIElements.TemplateContainer.md)  
