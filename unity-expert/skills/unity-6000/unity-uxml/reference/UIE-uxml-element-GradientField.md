...
The GradientField is an [Editor-only](UIB-interface-overview.md#enable-editor-extension-authoring-for-ui-documents-uxml) control that lets users set a color [gradient](../ScriptReference/Gradient.md) from a Gradient Editor.

![A GradientField control example](../uploads/Main/uxml/gradient-field.png)
...
**C# class**: [`GradientField`](../ScriptReference/UIElements.GradientField.md)  
...
| --- | --- | --- |
| `value` | `Gradient` | The `Gradient` currently being exposed by the field.  **Note**: Changing this doesn’t trigger sending a change event. |
...
* [Gradient](../ScriptReference/Gradient.md)
* [ColorField](UIE-uxml-element-ColorField.md)
* [GradientMode](../ScriptReference/GradientMode.md)