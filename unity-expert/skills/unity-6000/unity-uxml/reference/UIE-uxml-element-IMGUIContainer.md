...
The IMGUIContainer element renders [IMGUI](GUIScriptingGuide.md) code in a UI. You can use it to render complex UIs that aren’t possible with the existing UI Toolkit elements.
...
**C# class**: [`IMGUIContainer`](../ScriptReference/UIElements.IMGUIContainer.md)  
...
* [Immediate Mode GUI (IMGUI)](GUIScriptingGuide.md)