...
The TextElement displays text in a UI. If you create a [custom control](UIE-custom-controls.md) for displaying text, you can inherit it from a [TextElement](../ScriptReference/UIElements.TextElement.md).
...
**C# class**: [`TextElement`](../ScriptReference/UIElements.TextElement.md)  
