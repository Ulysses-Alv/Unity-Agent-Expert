...
A **Toolbar** is an [Editor-only](UIB-interface-overview.md#enable-editor-extension-authoring-for-ui-documents-uxml) control that serves as a horizontal container. You can add any **visual elements** into a Toolbar, but to have a consistent visual style within the Toolbar, use the following elements because they have a predefined style that matches the Toolbar style:

* [ToolbarButton](UIE-uxml-element-ToolbarButton.md) instead of [Button](UIE-uxml-element-Button.md).
* [ToolbarToggle](UIE-uxml-element-ToolbarToggle.md) instead of [Toggle](UIE-uxml-element-Toggle.md).
* [ToolbarSearchField](UIE-uxml-element-ToolbarSearchField.md)
* [ToolbarPopupSearchField](UIE-uxml-element-ToolbarPopupSearchField.md)
* [ToolbarMenu](UIE-uxml-element-ToolbarMenu.md) instead of [DropdownField](UIE-uxml-element-DropdownField.md).
* [ToolbarSpacer](UIE-uxml-element-ToolbarSpacer.md)
* [ToolbarBreadcrumbs](UIE-uxml-element-ToolbarBreadcrumbs.md)
...
**C# class**: [`Toolbar`](../ScriptReference/UIElements.Toolbar.md)  
...
* [ToolbarButton](UIE-uxml-element-ToolbarButton.md)
* [ToolbarToggle](UIE-uxml-element-ToolbarToggle.md)
* [ToolbarSearchField](UIE-uxml-element-ToolbarSearchField.md)
* [ToolbarPopupSearchField](UIE-uxml-element-ToolbarPopupSearchField.md)
* [ToolbarMenu](UIE-uxml-element-ToolbarMenu.md)
* [ToolbarSpacer](UIE-uxml-element-ToolbarSpacer.md)
* [ToolbarBreadcrumbs](UIE-uxml-element-ToolbarBreadcrumbs.md)