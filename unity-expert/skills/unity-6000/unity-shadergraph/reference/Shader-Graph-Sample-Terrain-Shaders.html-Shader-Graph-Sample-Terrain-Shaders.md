# Shaders | Shader Graph | 17.6.0

Source: [Original](https://docs.unity3d.com/Packages/com.unity.shadergraph@17.6/manual/Shader-Graph-Sample-Terrain-Shaders.html)

# Shaders

The names of these shaders indicate the [texture packing scheme](Shader-Graph-Sample-Terrain-Packing.html) they use, the type of layers they’re using, and the technique used to blend the layers together.
