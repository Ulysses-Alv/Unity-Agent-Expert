# Scene Color node | Shader Graph | 17.6.0

Source: [Original](https://docs.unity3d.com/Packages/com.unity.shadergraph@17.6/manual/Scene-Color-Node.html)
...
1. Connect the node to the fragment [shader stage](Shader-Stage.html). The Scene Color node doesn't support the vertex shader stage.
