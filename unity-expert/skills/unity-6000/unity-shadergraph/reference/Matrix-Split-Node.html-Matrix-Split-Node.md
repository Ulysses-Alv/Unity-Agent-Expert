# Matrix Split Node | Shader Graph | 17.6.0

Source: [Original](https://docs.unity3d.com/Packages/com.unity.shadergraph@17.6/manual/Matrix-Split-Node.html)
...
| Control | Description |
| --- | --- |
| (Dropdown) | Selects how the output vectors should be filled. The options are:  * **Row**: Output vectors are composed of matrix rows from top to bottom. * **Column**: Output vectors are composed of matrix columns from left to right. |
