# Create a shader graph asset | Shader Graph | 17.6.0

Source: [Original](https://docs.unity3d.com/Packages/com.unity.shadergraph@17.6/manual/Create-Shader-Graph.html)
...
1. In the **Project** window, right-click and select **Create** > **Shader Graph** > **From Template**.
   ...
   The [template browser](template-browser.html) lists all available templates according to your project's render pipeline.
2. Select the desired template and click **Create**.

   Unity creates a new shader graph asset in your project.
3. Name the shader graph asset.

You can now open the asset and edit the graph in the [Shader Graph window](Shader-Graph-Window.html).
...
To make such a blank shader graph functional, you have to define a [Target](Graph-Target.html) in the [Graph settings tab](Graph-Settings-Tab.html) of the Graph Inspector.

## Additional resources

* [Shader Graph template browser](template-browser.html)
* [Create a custom shader graph template](template-browser.html#create-a-custom-shader-graph-template)
