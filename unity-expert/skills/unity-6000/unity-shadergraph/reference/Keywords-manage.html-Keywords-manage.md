# Manage keywords in Shader Graph | Shader Graph | 17.6.0

Source: [Original](https://docs.unity3d.com/Packages/com.unity.shadergraph@17.6/manual/Keywords-manage.html)
...
1. Add a keyword in the [Blackboard](Blackboard.html) and define the [keyword parameters](Keywords-reference.html) according to your needs.
2. Add a [Keyword Node](Keyword-Node.html) in the graph from the keyword you defined in the Blackboard.
...
2. Connect each branch to a different input port of the Keyword Node according to the keyword value you want to use for later toggling.
3. Connect the output port of the Keyword Node to the node port you want to apply the conditional graph part to.
...
To be able to control a keyword from the Material Inspector, make sure to enable **Generate Material Property** in the [keyword parameters](Keywords-reference.html) in the graph.
...
* [Keyword parameter reference](Keywords-reference.html)