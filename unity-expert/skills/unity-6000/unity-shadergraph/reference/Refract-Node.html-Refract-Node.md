# Refract Node | Shader Graph | 17.6.0

Source: [Original](https://docs.unity3d.com/Packages/com.unity.shadergraph@17.6/manual/Refract-Node.html)
...
| Control | Description |
| --- | --- |
| **Mode** | Select a mode to handle results at the point of critical angle refraction. The options are:  * **Safe:** Returns a null vector result instead of a NaN result at the point of critical angle refraction. * **CriticalAngle:** Avoids the **Safe** check for a potential NaN result. |
