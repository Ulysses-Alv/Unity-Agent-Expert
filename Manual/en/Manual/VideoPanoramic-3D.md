...
1. [Set up a panoramic video](VideoPanoramic-setup.md).
2. If your video has a 360° view, [set up a panoramic video as a skybox](VideoPanoramic-skybox.md).
...
2. Set **3D Layout** to the layout of your panoramic video. For more information on the options, refer to [3D panoramic videos](VideoPanoramic-introduction.md#3d-panoramic).
...
3. Set **3D Layout** to the layout of your panoramic video. For more information on the options, refer to [3D panoramic videos](VideoPanoramic-introduction.md#3d-panoramic).
