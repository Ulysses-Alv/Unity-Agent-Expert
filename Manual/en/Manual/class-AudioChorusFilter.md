...
[Switch to Scripting](../ScriptReference/AudioChorusFilter.md "Go to AudioChorusFilter page in the Scripting Reference")

The **Audio Chorus Filter** takes an [Audio Clip](class-AudioClip.md) and processes it creating a chorus effect.

## Properties

![The AudioGroup Inspector displays the configurable properties of an Audio Chorus Filter.](../uploads/Main/AudioChorusFilter.png)

The AudioGroup Inspector displays the configurable properties of an Audio Chorus Filter.
