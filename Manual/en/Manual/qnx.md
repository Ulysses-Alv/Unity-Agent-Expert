...
| **Topic** | **Description** |
| --- | --- |
| [Get started with QNX](qnx-get-started.md) | Set up a project for QNX. |
| [Develop for QNX](qnx-develop.md) | Find information specific to QNX development, such as **plug-ins**, input, optional features, and troubleshooting. |
| [Build and deliver a QNX project](qnx-build-and-deliver.md) | Build and deliver your QNX application. |