...
A ToolbarToggle is an [Editor-only](UIB-interface-overview.md#enable-editor-extension-authoring-for-ui-documents-uxml) control that serves as a toggle in a [Toolbar](UIE-uxml-element-Toolbar.md). It’s a [Toggle](UIE-uxml-element-Toggle.md) with a predefined style that matches the Toolbar style. It looks like a button that you can toggle on and off.
...
**C# class**: [`ToolbarToggle`](../ScriptReference/UIElements.ToolbarToggle.md)  
**Namespace**: `UnityEditor.UIElements`  
**Base class**: [`Toggle`](../ScriptReference/UIElements.Toggle.md)
