# Modify surface options without changing your graph | Shader Graph | 17.6.0

Source: [Original](https://docs.unity3d.com/Packages/com.unity.shadergraph@17.6/manual/surface-options.html)
...
| Property | Behavior |
| --- | --- |
| **Workflow Mode** | Refer to the URP documentation for the [Lit URP](https://docs.unity3d.com/Manual/urp/lit-shader) Shader.  **Note**: Not applicable to URP Unlit and the Built-In Render Pipeline. |
| **Receive Shadows** | Refer to the URP documentation for the [Lit URP](https://docs.unity3d.com/Manual/urp/lit-shader) Shader.  **Note**: Not applicable to URP Unlit and the Built-In Render Pipeline. |
...
2. Save this graph.
3. Open the [Graph Inspector](Internal-Inspector.html).
