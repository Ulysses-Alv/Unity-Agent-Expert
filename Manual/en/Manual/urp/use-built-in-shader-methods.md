...
| [Use indirect lighting in a custom URP shader](use-built-in-shader-methods-indirect-lighting.md) | Use **reflection probes** or Adaptive Probe Volumes in a URP shader. |
...
| [ShaderLab Pass tags in URP reference](urp-shaders/urp-shaderlab-pass-tags.md) | Find the Pass tags URP uses to determine which shader passes to run in different parts of the **render pipeline**. |
