...
For information on converting assets made for a Built-in **Render Pipeline** project to assets compatible with 2D URP, refer to [Render Pipeline Converter](features/rp-converter.md).