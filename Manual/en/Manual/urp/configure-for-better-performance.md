...
Refer to [Universal Renderer](urp-universal-renderer.md) for more information about the three rendering paths in URP, and the performance effects and limitations of each one.
...
* [Strip shader variants in URP](urp/shader-stripping-landing.md) for features you don’t use.
