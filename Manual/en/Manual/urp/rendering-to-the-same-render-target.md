...
In the Universal **Render Pipeline** (URP), multiple [Base Cameras](camera-types-and-render-type-introduction.md#base-camera) or [Camera Stacks](camera-stacking.md) can render to the same render target. This allows you to create effects such as split screen rendering.
...
![Setting up split screen rendering in URP](../../uploads/urp/camera-split-screen-viewport.png)
