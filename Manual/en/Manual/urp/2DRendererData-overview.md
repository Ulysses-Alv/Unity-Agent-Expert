...
![The 2D Renderer Data Asset property settings](../../uploads/urp/2D/2dRendererData_properties.png)
...
![The 2D Renderer Data Asset property settings](../../uploads/urp/2D/Default_Material_Type.png)
...
![The 2D Renderer Data Asset property settings](../../uploads/urp/2D/Default_Custom_Material.png)
...
The 2D Renderer supports [URP Renderer Features](urp-renderer-feature.md). The setup for the features are called before any of the 2D built-in passes are queued.