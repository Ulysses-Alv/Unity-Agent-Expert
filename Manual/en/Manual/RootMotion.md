...
The Body Transform and Orientation are stored in the **Animation Clip** (using the [Muscle definitions](MuscleDefinitions.md) set up in the Avatar). They are the only world-space curves stored in the **Animation Clip**. Everything else: muscle curves and IK goals (Hands and Feet) are stored relative to the body transform.
...
![The Root Transform settings in the Animation Clip Inspector](../uploads/Main/MecanimRootMotion.png)

The Root Transform settings in the Animation Clip Inspector
