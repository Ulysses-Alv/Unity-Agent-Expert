...
The RectIntField lets users enter a [RectInt](../ScriptReference/RectInt.md) value in a UI.
...
**C# class**: [`RectIntField`](../ScriptReference/UIElements.RectIntField.md)  
...
* [RectField](UIE-uxml-element-RectField.md)