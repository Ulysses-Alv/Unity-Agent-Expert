...
When importing Model files into Unity from a 3D modeling application with a different scaling factor, you can convert the file units to use the Unity scale by enabling the [Convert Units](FBXImporter-Model.md#scene) option.
...
To import your file into Unity, follow the instructions for [Importing](ImportingModelFiles.md), keeping in mind how you set the export options in your 3D modeling software.