...
| **Topic** | **Description** |
| --- | --- |
| **[Gizmos introduction](gizmos-introduction.md)** | Learn about gizmos, icons, and selection wireframes in the Scene view. |
| **[Gizmos menu reference](GizmosMenu.md)** | Use the Gizmos menu in the Scene or Game view. |

## Additional resources

* [The Game view](GameView.md)
