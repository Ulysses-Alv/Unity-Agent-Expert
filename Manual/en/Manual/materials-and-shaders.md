...
| **Page** | **Description** |
| --- | --- |
| [Materials](Materials.md) | Resources for using materials to define the appearance of a scene. |
| [Prebuilt materials and shaders](built-in-materials-and-shaders.md) | Resources for using the shaders Unity provides to control the appearance of GameObjects in a scene. |
| [Custom textures](Textures-landing.md) | Resources for importing, converting, and loading textures so that you can use them in shaders and materials. |
| [Custom shaders](Shaders.md) | Resources for writing programs that run on the GPU to draw GameObjects in a scene. |
| [Color and High Dynamic Range (HDR)](graphics-color.md) | Resources for working with linear and gamma color spaces in Unity, and High Dynamic Range (HDR). |
| [Shader Import Settings window reference](class-ShaderImporter.md) | View and edit properties and settings for a prebuilt shader or a custom shader. |
