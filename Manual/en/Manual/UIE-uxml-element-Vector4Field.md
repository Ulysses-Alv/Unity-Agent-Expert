...
A Vector4Field lets users enter a [Vector4](../ScriptReference/Vector4.md) value.

**Note**: To align a Vector4Field with other fields in an **Inspector** window, simply apply the `.unity-base-field__aligned` USS class to it. For more information, refer to [`BaseField`](../ScriptReference/UIElements.BaseField_1.md).
...
**C# class**: [`Vector4Field`](../ScriptReference/UIElements.Vector4Field.md)  
