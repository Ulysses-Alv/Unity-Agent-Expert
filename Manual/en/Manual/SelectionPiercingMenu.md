...
Use the selection piercing menu to select a specific **GameObject** from a location that has multiple GameObjects.
...
* [Scene view context menu](SceneViewContextMenu.md)
