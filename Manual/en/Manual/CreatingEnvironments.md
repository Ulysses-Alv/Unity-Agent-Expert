...
![A screenshot from the Unity Terrain HDRP Demo Scene](../uploads/Main/terrain-landing.png)
...
| **Topic** | **Description** |
| --- | --- |
| [Sky](sky.md) | Use skyboxes in your project. |
| [Terrain](script-Terrain.md) | Information on Unity’s built-in Terrain features. These consist of tools that let you create and modify landscapes in the Unity Editor, and runtime features that optimize Terrain rendering. |
| [Terrain Tools](TerrainTools.md) | Information on the Terrain Tools package, which provides additional Editor tooling functionality on top of the built-in Terrain features. |
...
* 👥 **Community**: [Join the conversation on Unity Discussions](https://discussions.unity.com/lists/world-building)