...
The RectField lets users enter a [Rect](../ScriptReference/Rect.md) value in a UI.
...
**C# class**: [`RectField`](../ScriptReference/UIElements.RectField.md)  
...
* [RectIntField](UIE-uxml-element-RectIntField.md)