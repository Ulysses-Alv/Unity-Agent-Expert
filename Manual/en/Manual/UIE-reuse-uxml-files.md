...
When you design a large user interface, you can create template UXML files that define parts of the UI, and use the [`<Template>` and `<Instance>`](UIE-ElementRef.md#templates) elements to import it into another UXML file.
...
* Attribute overrides find matching attributes according to the element name you specify. You can’t use [USS Selectors](UIE-USS-Selectors.md) or [UQuery](UIE-UQuery.md) to match elements.
...
* [Templates](UIE-ElementRef.md#templates)
