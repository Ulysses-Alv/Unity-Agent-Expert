...
To deploy your Universal Windows Platform (UWP) application, you first need to [build your project](windowsstore-buildsettings.md). After Unity generates your Visual Studio solution, you can deploy your application. For more information, refer to Microsoft documentation on [deploying UWP apps from Visual Studio](https://learn.microsoft.com/en-us/visualstudio/debugger/deploy-windows-store-apps-from-visual-studio).
...
* [Deploy a UWP app with the Windows Device Portal](windowsstore-deviceportal.md)