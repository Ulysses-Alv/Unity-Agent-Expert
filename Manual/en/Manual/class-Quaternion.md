...
[Switch to Scripting](../ScriptReference/Quaternion.md "Go to Quaternion page in the Scripting Reference")
...
* [`Quaternion.LookRotation`](../ScriptReference/Quaternion.LookRotation.md)
* [`Quaternion.Angle`](../ScriptReference/Quaternion.Angle.md)
* [`Quaternion.AngleAxis`](../ScriptReference/Quaternion.AngleAxis.md)
* [`Quaternion.FromToRotation`](../ScriptReference/Quaternion.FromToRotation.md)

### Manipulating Rotations:

* [`Quaternion.Slerp`](../ScriptReference/Quaternion.Slerp.md)
* [`Quaternion.Inverse`](../ScriptReference/Quaternion.Inverse.md)
* [`Quaternion.RotateTowards`](../ScriptReference/Quaternion.RotateTowards.md)

The Transform class also provides methods which allow you to work with the Quaternion rotations:

* [`Transform.Rotate`](../ScriptReference/Transform.Rotate.md) & [`Transform.RotateAround`](../ScriptReference/Transform.RotateAround.md)
...
You can read more detail about exactly how these problems can arise in the [eulerAngles script reference page](../ScriptReference/Quaternion-eulerAngles.md).
...
* [Quaternion and euler rotations in Unity](QuaternionAndEulerRotationsInUnity.md)
* [`Quaternion` API reference](../ScriptReference/Quaternion.md)