...
**Note**: For information about using the Package Manager window to import an asset package you purchased or downloaded from the **Asset Store**, refer to [Download and import an asset package](upm-ui-import.md).
