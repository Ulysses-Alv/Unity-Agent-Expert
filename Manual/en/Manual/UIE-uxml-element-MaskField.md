...
The MaskField is an [Editor-only](UIB-interface-overview.md#enable-editor-extension-authoring-for-ui-documents-uxml) control that lets users select one or more options from a list of options.

The difference between MaskField and [Mask64Field](UIE-uxml-element-Mask64Field.md) is that MaskField supports a 32-bit bitmask while Mark64Field supports a 64-bit bitmask.
...
**C# class**: [`MaskField`](../ScriptReference/UIElements.MaskField.md)  
