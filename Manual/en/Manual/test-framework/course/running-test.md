...
Import the [sample](test-framework-general-introduction.md#import-samples) `1_RunningTest_Project` into your Unity Editor (version 2019.2 or newer) from the Package Manager window.
