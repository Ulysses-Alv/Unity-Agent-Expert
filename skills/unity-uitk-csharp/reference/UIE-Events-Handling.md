...
For more information, see [Dispatching events](UIE-Events-Dispatching.md).
...
For information on how to get access to a visual element from a MonoBehaviour, refer to [Get started with runtime UI](UIE-get-started-with-runtime-ui.md).
...
For more information, see [Change events](UIE-Change-Events.md)
