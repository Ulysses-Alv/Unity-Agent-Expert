# Rounded Rectangle node | Shader Graph | 17.6.0

Source: [Original](https://docs.unity3d.com/Packages/com.unity.shadergraph@17.6/manual/Rounded-Rectangle-Node.html)
...
* To offset the shape, input a [Tiling And Offset node](Tiling-And-Offset-Node.html) and adjust the **Offset** property.
* To tile the shape, input a [Tiling and Offset node](Fraction-Node.html) into a [Fraction node](Tiling-And-Offset-Node.html), then input the Fraction node into the Rounded Rectangle node.
