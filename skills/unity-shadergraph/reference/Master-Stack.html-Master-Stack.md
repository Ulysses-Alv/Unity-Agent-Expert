# Master Stack | Shader Graph | 17.6.0

Source: [Original](https://docs.unity3d.com/Packages/com.unity.shadergraph@17.6/manual/Master-Stack.html)
...
The content of the Master Stack might change depending on the [Graph Settings](Graph-Settings-Tab.html) you select. The Master Stack is made up of Contexts, which contain [Block nodes](Block-Node.html).
