# Shader Graph Preferences | Shader Graph | 17.6.0

Source: [Original](https://docs.unity3d.com/Packages/com.unity.shadergraph@17.6/manual/Shader-Graph-Preferences.html)
...
| **Graph Template Workflow** | Sets whether Unity creates new materials as [material variants](https://docs.unity3d.com/Manual/materialvariant-concept.html) from the child asset of the shader graph asset, or as standalone materials. The options are:  * **Material Variant**: Unity creates material variants from the child asset of the shader graph asset. * **Material**: Unity creates standalone materials. |
...
* [Shader graph project settings](Shader-Graph-Project-Settings.html)