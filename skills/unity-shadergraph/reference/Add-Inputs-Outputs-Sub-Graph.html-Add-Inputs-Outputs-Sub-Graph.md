# Add inputs and outputs to a Sub Graph | Shader Graph | 17.6.0

Source: [Original](https://docs.unity3d.com/Packages/com.unity.shadergraph@17.6/manual/Add-Inputs-Outputs-Sub-Graph.html)

# Add inputs and outputs to a Sub Graph

To pass data in and out of a [Sub Graph](Sub-graph.html), create input and output ports.
...
3. In the **Graph Inspector** window, select the **Node Settings** tab.
4. Under **Inputs**, select the Add (**+**) button.
5. Use the dropdown to select the output type.
...
For more information, refer to [Custom Port Menu](Custom-Port-Menu.html).
