# Sample Texture 2D LOD Node | Shader Graph | 17.6.0

Source: [Original](https://docs.unity3d.com/Packages/com.unity.shadergraph@17.6/manual/Sample-Texture-2D-LOD-Node.html)
...
This [Node](Node.html) is useful for sampling a **Texture** in the vertex [Shader Stage](Shader-Stage.html) as the [Sample Texture 2D Node](Sample-Texture-2D-Node.html) is unavailable in this [Shader Stage](Shader-Stage.html).
