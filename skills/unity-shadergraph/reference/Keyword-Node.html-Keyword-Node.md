# Keyword node | Shader Graph | 17.6.0

Source: [Original](https://docs.unity3d.com/Packages/com.unity.shadergraph@17.6/manual/Keyword-Node.html)

# Keyword node

## Description

You can use a Keyword node to create branches or shader variants that reference [Keywords](Keywords.html) on the [Blackboard](Blackboard.html).
