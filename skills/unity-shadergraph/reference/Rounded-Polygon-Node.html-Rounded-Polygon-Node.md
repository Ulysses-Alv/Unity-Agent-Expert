# Rounded Polygon Node | Shader Graph | 17.6.0

Source: [Original](https://docs.unity3d.com/Packages/com.unity.shadergraph@17.6/manual/Rounded-Polygon-Node.html)
...
You can connect a [Tiling And Offset Node](Tiling-And-Offset-Node.html) to offset or tile the shape. To preserve the ability to offset the shape within the UV space, the shape does not automatically repeat if you tile it. To achieve a repeating rounded polygon effect, first connect your **UV** input through a [Fraction Node](Fraction-Node.html).

You can only use the Rounded Polygon Node in the **Fragment** [Shader Stage](Shader-Stage.html).
