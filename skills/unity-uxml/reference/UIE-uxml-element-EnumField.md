...
**Note**: To align an EnumField with other fields in an **Inspector** window, simply apply the `.unity-base-field__aligned` USS class to it. For more information, refer to [`BaseField`](../ScriptReference/UIElements.BaseField_1.md).
...
**C# class**: [`EnumField`](../ScriptReference/UIElements.EnumField.md)  
...
* [EnumFlagsField](UIE-uxml-element-EnumFlagsField.md)