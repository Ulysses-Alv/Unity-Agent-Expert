...
The BoundsField lets users enter a [Bounds](../ScriptReference/Bounds.md) value in a UI.
...
**C# class**: [`BoundsField`](../ScriptReference/UIElements.BoundsField.md)  
...
* [BoundsIntField](UIE-uxml-element-BoundsIntField.md)