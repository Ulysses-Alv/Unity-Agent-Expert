...
To create a ProgressBar with C#, create a new instance of a [ProgressBar](../ScriptReference/UIElements.ProgressBar.md) object. For example:
...
**C# class**: [`ProgressBar`](../ScriptReference/UIElements.ProgressBar.md)  
**Namespace**: `UnityEngine.UIElements`  
**Base class**: [`AbstractProgressBar`](../ScriptReference/UIElements.AbstractProgressBar.md)
