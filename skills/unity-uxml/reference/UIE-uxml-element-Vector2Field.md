...
A Vector2Field lets users enter a [Vector2](../ScriptReference/Vector2.md) value.

**Note**: To align a Vector2Field with other fields in an **Inspector** window, simply apply the `.unity-base-field__aligned` USS class to it. For more information, refer to [`BaseField`](../ScriptReference/UIElements.BaseField_1.md).
...
**C# class**: [`Vector2Field`](../ScriptReference/UIElements.Vector2Field.md)  
